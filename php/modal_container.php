...
<div class="modal fade" id="reservation_modal" tabindex="-1" role="dialog" aria-labelledby="reservationModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="reservationModalLabel">Reservation</h3>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
...
<div class="modal fade" id="universal_modal" tabindex="-1" role="dialog" aria-labelledby="universalModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="universalModalLabel"></h3>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
	...
	<div class="modal-dialog modal-confirm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<h4>Great!</h4>
				<p class="text-black-50">Your reservation has been submitted, wait for email notification approval.</p>
				<a href="index.php" id="start_explore" class="btn btn-branding" data-dismiss="modal">Start Exploring <i class="fa fa-arrow-right"></i></a>
			</div>
		</div>
	</div>
</div>