      ...
      <div class="col-md-4 offset-md-4 form-wrapper auth">
        ...
        <form action="signup.php" method="post">
          <div class="form-group">
            ...
            <input type="text" name="username" class="form-control form-control-lg" value="jervz">
          </div>
          <div class="form-group">
            <label>Email</label>
            <input type="text" name="email" class="form-control form-control-lg" value="jervyariola@gmail.com">
          </div>
          <div class="form-group">
